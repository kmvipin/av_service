...
public class ContactDao {
    ...
    public void saveContactMsg(Contact contact){
        ...
        String sql = "INSERT INTO CONTACT_MSG (contact_id, person_id, name, " +
                "mobile_num, email, subject, message, status) " +
                "VALUES (?,?,?,?,?,?,?,?)";
        jdbcTemplate.update(sql,contact.getContact_id(),contact.getPerson_id(),
    ...
    public List<Contact> findMsgsWithStatus(String status){
        ...
        return jdbcTemplate.query(sql,new ContactRowMapper(),"ACTIVE");
    }
